...
homes_set = ['egauge1974', 'egauge1590', 'egauge1955', 'egauge1956']
timezones = ['America/Denver', 'America/Chicago', 'America/Denver', 'America/Denver']
...
# --------------------------------------------------Webpage reader------------------------------------------------------
    ...
    if os.path.isfile('full_list_remainder.csv'):
        previous_full_list = pd.read_csv('full_list_remainder.csv', sep=',')
        full_list = previous_full_list.append(full_list, ignore_index=True)
    full_list.to_csv('full_list_remainder.csv', sep=',', encoding='utf-8', index=False)
    # time.sleep(60)
